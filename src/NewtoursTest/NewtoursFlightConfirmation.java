...
public class NewtoursFlightConfirmation {
	...
	public static void main(String[] args) {
		...
		String newtours = "http://newtours.demoaut.com/mercuryreservation2.php";
		// 1 Login
		...
		if (actualUrl.equals(expectedUrl)) {
			System.out.println("Verification Passed! current Page1  flightPageUrl1.");
		} else {
			System.out.println("Verification Failed. current Page1  flightPageUrl1.");
		}
		// Title
		...
		if (actualTitle1.equals(expectedTitle1)) {
			...
			System.out.println("Verification Failed. current Title");
		}
		// 4 Book A Flight
